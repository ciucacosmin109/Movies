...
import com.marius.movies.MainActivity;
...
public class FavoritesFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            case R.id.add_movie:
                ...
                intent.putExtra("saveFavorites", true);
        ...
        public void OnOptionClick(View v, MenuItem item, int position) {
            switch(item.getItemId()){
                ...
                case R.id.movie_item_option_move:
                    // Remove from fav table & add to wl table
                    if(mainActivity != null) {
                        movies.get(position).movie.setMovie_list(Movie.MOVIE_LIST.WATCHLIST);
                        AppData.room_updateMovieWithGenres(mainActivity, movies.get(position));
                    }

                    // Add to wl
                    AppData.watchlistMovies.add(movies.get(position));
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode){
            case REQUEST_CODE_ADD_MOVIE:
                ...
                if(mainActivity != null) {
                    newMv.movie.setMovie_list(Movie.MOVIE_LIST.FAVORITES);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        movies = AppData.favoritesMovies;

        recyclerView = view.findViewById(R.id.favorite_movies);
        movieAdapter = new MovieAdapter(getContext(), movies, R.menu.movie_item_options_fav);
        ...
        if(getActivity() != null) {
            ...
            AppData.room_fetchMovieWithGenres(mainActivity, Movie.MOVIE_LIST.FAVORITES, new AppData.onMoviesFetchedListener() {
                @Override
